...
export const sendChatMessageApi = async (message, replyToMessageId = null) => (await apiClient.post('/chat/messages', { message, reply_to_message_id: replyToMessageId })).data;
